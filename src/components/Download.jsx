...
const Download = () => {
  return (
    <section className='relative w-[93%] h-[40vh] float-right rounded-tl-3xl px-5 rounded-bl-3xl mt-20 overflow-hidden bg-gradient-to-l from-[#FAEAB1] to-[#FFFFFF] shadow-[inset_0px_0px_20px_rgba(0,0,0,0.6)] flex justify-evenly items-center'>
