        ...
        { type === 'password' ? 
                              <><div 
                                  ...
                                  <input 
                                    ...
                                    />
                                      {isShow ? 
                                              <BsEyeSlash  className='text-xl text-white md:text-[28px] text-[#999] mr-2 cursor-pointer' 
                                              onClick={()=>setIsShow(!isShow)}/> 
                                              : 
                                              <BsEye  className='text-xl text-white md:text-[28px] text-[#999] mr-2 cursor-pointer' 
                                              onClick={()=>setIsShow(!isShow)}/>}
