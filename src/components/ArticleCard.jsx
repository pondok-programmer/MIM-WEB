...
const ArticleCard = ({img,title}) => {
  return (
    <section className="relative rounded-lg p-[7px] w-[330px] h-fit bg-[#FAEAB1] shadow-[0px_0px_10px_rgba(0,0,0,0.3)]">
        <section className="rounded-lg h-[37vh] overflow-hidden shadow-[0px_0px_10px_rgba(0,0,0,0.3)] border-white border-2 relative before:w-full before:h-full before:absolute before:bg-gradient-to-t before:from-black/60 before:from-1% before:to-transparent before:to-70% before:z-10">
